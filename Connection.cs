...
namespace PartChecker
{
    class Connection
    {
        ...
        public static string strProvider = "server=" + host + ";Database=" + database + ";User ID=" + userDB + ";Password=" + password + "MultipleActiveResultSets=True;";
        public bool Open()
        {
            try
            {
        ...
        public MySqlDataReader ExecuteReaderIgnore(string sql)
        {
            try
            {
                MySqlDataReader reader;
